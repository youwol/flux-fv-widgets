...
Collection of basic widgets (essentially from @youwol/fv-widgets)
...
You can find the documentation [here](https://youwol.github.io/$flux-fv-widgets/dist/docs/index.html).
